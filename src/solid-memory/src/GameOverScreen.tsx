    ...
    return (
        <div class="maw-min-w-[640px]">
            ...
            <div class="animate-winner">
                <Show when={isTie()}>
                    <div class="maw-flex maw-justify-center maw-mb-8 maw-gap-24">
                    ...
                    <div class="maw-font-cursive maw-text-12 maw-c-yellow-3 maw-text-center maw-mt-4">Tie!</div>
                </Show>
                <Show when={!isTie()}>
                    <div class="maw-mb-8 maw-text-center">
                        <img class="maw-h-[192px] maw-w-[150px]" src={winner()?.turtle.imageUrl} />
                    </div>
                    <div class={`maw-font-cursive maw-text-12 maw-my-4 maw-text-center ${Style[`turtle-color-${winner()!.turtle.color}`]}`}>{winner()?.turtle.name} Wins!</div>
                    <div class="maw-font-cursive maw-text-12 maw-c-yellow-3 maw-text-center">Flawless Victory!</div>
                </Show>
