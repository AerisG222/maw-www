    ...
    : IValidatableObject
{
    ...
    public GpsLatitudeReference? DmsLatReference { get; set; }
    ...
    float GetLatitudeDegrees(float? degree, GpsLatitudeReference? latRef)
    {
    ...
    float GetLongitudeDegrees(float? degree, GpsLongitudeReference? lngRef)
    {
        ArgumentNullException.ThrowIfNull(degree);
